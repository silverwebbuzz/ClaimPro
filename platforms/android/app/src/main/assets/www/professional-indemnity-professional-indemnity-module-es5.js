...
var ProfessionalIndemnityPageModule = /** @class */ (function () {
    function ProfessionalIndemnityPageModule() {
    }
    ...
    return ProfessionalIndemnityPageModule;
}());
...
var ProfessionalIndemnityPage = /** @class */ (function () {
    function ProfessionalIndemnityPage(navCtrl, router, formBuilder, statusBar, _cS, actionSheetCtrl) {
    ...
    ProfessionalIndemnityPage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    ProfessionalIndemnityPage.prototype.professional_fb = function () {
    ...
    ProfessionalIndemnityPage.prototype.professionalNext = function () {
        var _this = this;
        for (var v in this.professional_form.controls) {
        ...
        if (this.professional_form.valid) {
            ...
            this._cS.post_API(this._cS.URL_Professional_Claim_FirstStep_Post(), step0)
                ...
                if (data.status == 0) {
                    ...
                    localStorage.setItem('ProfessionalClaimNumber', _this.Claim_number);
                    _this.setClaimData();
                    _this.router.navigate(['/professional-step1']);
                }
                else {
                }
            }, function (err) {
    ...
    ProfessionalIndemnityPage.prototype.ngOnInit = function () {
    };
    ProfessionalIndemnityPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    ProfessionalIndemnityPage.prototype.detail = function () {
    ...
    ProfessionalIndemnityPage.prototype.radioButtonValue = function (val) { if (val == 1) {
        return true;
    }
    else {
        return false;
    } };
    ProfessionalIndemnityPage.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.professional_form.setValue({
    ...
    ProfessionalIndemnityPage.ctorParameters = function () { return [
    ...
    return ProfessionalIndemnityPage;
}());
...
//# sourceMappingURL=professional-indemnity-professional-indemnity-module-es5.js.map
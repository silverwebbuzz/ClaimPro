...
var ImpactByCollisionPageModule = /** @class */ (function () {
    function ImpactByCollisionPageModule() {
    }
    ...
    return ImpactByCollisionPageModule;
}());
...
var ImpactByCollisionPage = /** @class */ (function () {
    function ImpactByCollisionPage(navCtrl, router, formBuilder, statusBar) {
    ...
    ImpactByCollisionPage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    ImpactByCollisionPage.prototype.impact_by_coliision_fb = function () {
    ...
    ImpactByCollisionPage.prototype.ImpactByColiisionNext = function () {
        for (var v in this.impact_by_coliision_form.controls) {
    ...
    ImpactByCollisionPage.prototype.ngOnInit = function () {
    };
    ImpactByCollisionPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    ImpactByCollisionPage.ctorParameters = function () { return [
...
//# sourceMappingURL=property-property-step3-impact-by-collision-impact-by-collision-module-es5.js.map
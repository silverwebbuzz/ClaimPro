...
var VehiclePage = /** @class */ (function () {
    function VehiclePage(navCtrl, router, _cS, formBuilder, statusBar, actionSheetCtrl) {
    ...
    VehiclePage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    VehiclePage.prototype.vehicle_fb = function () {
    ...
    VehiclePage.prototype.vehicleNext = function () {
        var _this = this;
        for (var v in this.vehicle_form.controls) {
            ...
            if (this.vehicle_form.value.policy_holder == 'true') {
                this._cS.post_API(this._cS.URL_Vehicle_Claim_FirstStep_Post(), step0)
                    ...
                    if (data.status == 0) {
                        ...
                        localStorage.setItem('ClaimNumber', _this.Claim_number);
                        _this.router.navigate(['/vehicle-step1']);
                    }
                    else {
                    }
                }, function (err) {
    ...
    VehiclePage.prototype.setClaimData = function () {
        var _this = this;
    ...
    VehiclePage.prototype.back = function () {
        this.navCtrl.pop();
    };
    VehiclePage.prototype.detail = function () {
    ...
    VehiclePage.ctorParameters = function () { return [

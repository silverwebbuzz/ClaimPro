...
var GeneralStep2PageModule = /** @class */ (function () {
    function GeneralStep2PageModule() {
    }
...
var GeneralStep2Page = /** @class */ (function () {
    /* dropdown option Variable End */
    function GeneralStep2Page(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    GeneralStep2Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    GeneralStep2Page.prototype.general_step2_fb = function () {
    ...
    GeneralStep2Page.prototype.formControlValueChanged = function () {
        var _this = this;
        this.general_form_step2.get('complaint_writing')
            .valueChanges.subscribe(function (val) {
            var date_loss = _this.general_form_step2.get('date_loss');
            var time_loss = _this.general_form_step2.get('time_loss');
            var where_loss_damage = _this.general_form_step2.get('where_loss_damage');
        ...
        this.general_form_step2.get('how_aware_complaint')
            .valueChanges.subscribe(function (val) {
            var how_aware_complaint_other = _this.general_form_step2.get('how_aware_complaint_other');
            if (val == "Other") {
        ...
        this.general_form_step2.get('where_loss_damage')
            .valueChanges.subscribe(function (val) {
            var risk_street = _this.general_form_step2.get('risk_street');
            var risk_suburb = _this.general_form_step2.get('risk_suburb');
            var risk_state = _this.general_form_step2.get('risk_state');
            var risk_postcode = _this.general_form_step2.get('risk_postcode');
            var risk_country = _this.general_form_step2.get('risk_country');
            var where_loss_damage_other = _this.general_form_step2.get('where_loss_damage_other');
    ...
    GeneralStep2Page.prototype.GeneralStep2Next = function () {
        var _this = this;
        for (var v in this.general_form_step2.controls) {
        ...
        if (this.general_form_step2.valid) {
            ...
            this._cS.put_API(this._cS.URL_General_Claim_Post(), step2)
                ...
                if (data.status == 0) {
                    _this.data = [];
                    _this.setClaimData();
                    _this.router.navigate(['/general-step3']);
                }
                else {
                }
            }, function (err) {
    ...
    GeneralStep2Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    GeneralStep2Page.prototype.occurchange = function ($event) {
        var _this = this;
    ...
    GeneralStep2Page.prototype.riskAddress = function () {
        var _this = this;
        ...
        returnResult.subscribe(function (val) {
            if (val) {
                ...
                _this.general_form_step2.patchValue(JSON);
            }
        });
    };
    GeneralStep2Page.prototype.deleteImage = function (img, position) {
        var _this = this;
    ...
    GeneralStep2Page.prototype.fileUpload = function (event) {
        var _this = this;
    ...
    GeneralStep2Page.prototype.dynamicImages = function (array, path) {
        var _this = this;
    ...
    GeneralStep2Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    GeneralStep2Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.general_form_step2.setValue({
    ...
    GeneralStep2Page.ctorParameters = function () { return [
...
//# sourceMappingURL=general-liability-general-step2-general-step2-module-es5.js.map
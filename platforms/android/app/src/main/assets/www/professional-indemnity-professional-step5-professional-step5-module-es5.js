...
var ProfessionalStep5PageModule = /** @class */ (function () {
    function ProfessionalStep5PageModule() {
    }
    ...
    return ProfessionalStep5PageModule;
}());
...
var ProfessionalStep5Page = /** @class */ (function () {
    function ProfessionalStep5Page(navCtrl, router, formBuilder, _cS, statusBar) {
    ...
    ProfessionalStep5Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    ProfessionalStep5Page.prototype.professional_step5_fb = function () {
    ...
    ProfessionalStep5Page.prototype.formControlValueChanged = function () {
        var _this = this;
        this.professional_form_step5.get('personal_injury')
            .valueChanges.subscribe(function (val) {
            var how_injury_occur = _this.professional_form_step5.get('how_injury_occur');
            var nature_injury = _this.professional_form_step5.get('nature_injury');
            var date_loss = _this.professional_form_step5.get('date_loss');
        ...
        this.professional_form_step5.get('type_damage')
            .valueChanges.subscribe(function (val) {
            var type_damage_other = _this.professional_form_step5.get('type_damage_other');
            if (val == "Other") {
        ...
        this.professional_form_step5.get('reported_loss')
            .valueChanges.subscribe(function (val) {
            var reported_loss_other = _this.professional_form_step5.get('reported_loss_other');
            if (val == "Other") {
    ...
    ProfessionalStep5Page.prototype.professionalStep5Next = function () {
        var _this = this;
        for (var v in this.professional_form_step5.controls) {
        ...
        if (this.professional_form_step5.valid) {
            ...
            this._cS.put_API(this._cS.URL_Professional_Claim_Post(), step5)
                ...
                if (data.status == 0) {
                    _this.setClaimData();
                    _this.router.navigate(['/professional-step6']);
                }
                else {
                }
            }, function (err) {
    ...
    ProfessionalStep5Page.prototype.ngOnInit = function () {
    };
    ProfessionalStep5Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    ProfessionalStep5Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.professional_form_step5.setValue({
    ...
    ProfessionalStep5Page.ctorParameters = function () { return [
...
//# sourceMappingURL=professional-indemnity-professional-step5-professional-step5-module-es5.js.map
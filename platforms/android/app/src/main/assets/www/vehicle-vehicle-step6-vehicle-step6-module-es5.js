...
var VehicleStep6PageModule = /** @class */ (function () {
    function VehicleStep6PageModule() {
    }
...
var VehicleStep6Page = /** @class */ (function () {
    function VehicleStep6Page(navCtrl, router, _cS, route, formBuilder, statusBar) {
    ...
    VehicleStep6Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    VehicleStep6Page.prototype.vehicle_step6_fb = function () {
    ...
    VehicleStep6Page.prototype.formControlValueChanged = function () {
        var _this = this;
        this.vehicle_form_step6.get('reported_to_police')
            .valueChanges.subscribe(function (val) {
            var police_report_date = _this.vehicle_form_step6.get('police_report_date');
            var which_station = _this.vehicle_form_step6.get('which_station');
            var police_report_number = _this.vehicle_form_step6.get('police_report_number');
            var police_laid_charges = _this.vehicle_form_step6.get('police_laid_charges');
        ...
        this.vehicle_form_step6.get('police_laid_charges')
            .valueChanges.subscribe(function (val) {
            var police_who_charged = _this.vehicle_form_step6.get('police_who_charged');
    ...
    VehicleStep6Page.prototype.vehicleStep6Next = function () {
        var _this = this;
        for (var v in this.vehicle_form_step6.controls) {
        ...
        if (this.vehicle_form_step6.valid) {
            ...
            this._cS.put_API(this._cS.URL_Vehicle_Claim_Post(), step6)
                ...
                if (data.status == 0) {
                    _this.data = [];
                    _this.setClaimData();
                    _this.router.navigate(['/vehicle-step7']);
                }
                else {
                }
            }, function (err) {
    ...
    VehicleStep6Page.prototype.ngOnInit = function () {
    };
    VehicleStep6Page.prototype.deleteImage = function (img, position) {
        var _this = this;
    ...
    VehicleStep6Page.prototype.fileUpload = function (event) {
        var _this = this;
    ...
    VehicleStep6Page.prototype.dynamicImages = function (array, path) {
        var _this = this;
    ...
    VehicleStep6Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.vehicle_form_step6.setValue({
                        ...
                        police_laid_charges: _this.editClaimData.police_laid_charges,
                        police_who_charged: _this.editClaimData.police_who_charged,
                    });
    ...
    VehicleStep6Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    VehicleStep6Page.ctorParameters = function () { return [
...
//# sourceMappingURL=vehicle-vehicle-step6-vehicle-step6-module-es5.js.map
...
var MedicalMalpracticePageModule = /** @class */ (function () {
    function MedicalMalpracticePageModule() {
    }
    ...
    return MedicalMalpracticePageModule;
}());
...
var MedicalMalpracticePage = /** @class */ (function () {
    function MedicalMalpracticePage(navCtrl, router, _cS, formBuilder, statusBar, actionSheetCtrl) {
    ...
    MedicalMalpracticePage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    MedicalMalpracticePage.prototype.medical_fb = function () {
    ...
    MedicalMalpracticePage.prototype.medicalNext = function () {
        var _this = this;
        for (var v in this.medical_form.controls) {
        ...
        if (this.medical_form.valid) {
            ...
            this._cS.post_API(this._cS.URL_Medical_Claim_FirstStep_Post(), step0)
                ...
                if (data.status == 0) {
                    ...
                    localStorage.setItem('MedicalClaimNumber', _this.Claim_number);
                    // this.setClaimData();
                    _this.router.navigate(['/medical-step1']);
                }
                else {
    ...
    MedicalMalpracticePage.prototype.ngOnInit = function () {
    };
    MedicalMalpracticePage.prototype.back = function () {
        this.navCtrl.pop();
    };
    MedicalMalpracticePage.prototype.setClaimData = function () {
        var _this = this;
    ...
    MedicalMalpracticePage.prototype.detail = function () {
    ...
    MedicalMalpracticePage.ctorParameters = function () { return [
...
//# sourceMappingURL=medical-malpractice-medical-malpractice-module-es5.js.map
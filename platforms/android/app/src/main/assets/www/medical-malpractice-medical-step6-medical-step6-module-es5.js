...
var MedicalStep6PageModule = /** @class */ (function () {
    function MedicalStep6PageModule() {
    }
...
var MedicalStep6Page = /** @class */ (function () {
    function MedicalStep6Page(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    MedicalStep6Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    MedicalStep6Page.prototype.medical_step6_fb = function () {
    ...
    MedicalStep6Page.prototype.formControlValueChanged = function () {
        var _this = this;
        this.medical_form_step6.get('previous_claims')
            .valueChanges.subscribe(function (val) {
            var previous_claim_date = _this.medical_form_step6.get('previous_claim_date');
            var previous_type_claim = _this.medical_form_step6.get('previous_type_claim');
            var previous_insurer = _this.medical_form_step6.get('previous_insurer');
        ...
        this.medical_form_step6.get('previous_type_claim')
            .valueChanges.subscribe(function (val) {
            var previous_type_claim_other = _this.medical_form_step6.get('previous_type_claim_other');
            if (val == 'Other') {
    ...
    MedicalStep6Page.prototype.medicalStep6Next = function () {
        var _this = this;
        for (var v in this.medical_form_step6.controls) {
        ...
        if (this.medical_form_step6.valid) {
            ...
            this._cS.put_API(this._cS.URL_Medical_Claim_Post(), step6)
                ...
                if (data.status == 0) {
                    _this.setClaimData();
                    _this.router.navigate(['/medical-step7']);
                }
                else {
                }
            }, function (err) {
    ...
    MedicalStep6Page.prototype.ngOnInit = function () {
    };
    MedicalStep6Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    MedicalStep6Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.medical_form_step6.setValue({
    ...
    MedicalStep6Page.ctorParameters = function () { return [
...
//# sourceMappingURL=medical-malpractice-medical-step6-medical-step6-module-es5.js.map
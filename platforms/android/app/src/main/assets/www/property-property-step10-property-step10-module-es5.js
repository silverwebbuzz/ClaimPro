...
var PropertyStep10PageModule = /** @class */ (function () {
    function PropertyStep10PageModule() {
    }
    ...
    return PropertyStep10PageModule;
}());
...
var PropertyStep10Page = /** @class */ (function () {
    function PropertyStep10Page(navCtrl, _cS, route, router, statusBar) {
        var _this = this;
    ...
    PropertyStep10Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    PropertyStep10Page.prototype.submitFeedBack = function (claim_id, Feedback) {
        var _this = this;
        var body = {
            claimid: +claim_id,
    ...
    ;
    PropertyStep10Page.prototype.ngOnInit = function () {
    };
    PropertyStep10Page.ctorParameters = function () { return [
...
//# sourceMappingURL=property-property-step10-property-step10-module-es5.js.map
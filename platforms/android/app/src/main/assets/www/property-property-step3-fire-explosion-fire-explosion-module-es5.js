...
var FireExplosionPageModule = /** @class */ (function () {
    function FireExplosionPageModule() {
    }
    ...
    return FireExplosionPageModule;
}());
...
var FireExplosionPage = /** @class */ (function () {
    function FireExplosionPage(navCtrl, router, formBuilder, statusBar) {
    ...
    FireExplosionPage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    FireExplosionPage.prototype.fire_explosion_fb = function () {
    ...
    FireExplosionPage.prototype.fireExplosionNext = function () {
        for (var v in this.fire_explosion_form.controls) {
    ...
    FireExplosionPage.prototype.ngOnInit = function () {
    };
    FireExplosionPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    FireExplosionPage.ctorParameters = function () { return [
...
//# sourceMappingURL=property-property-step3-fire-explosion-fire-explosion-module-es5.js.map
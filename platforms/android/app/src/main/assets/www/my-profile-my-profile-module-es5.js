...
var MyProfilePage = /** @class */ (function () {
    function MyProfilePage(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    MyProfilePage.prototype.profile_fb = function () {
    ...
    MyProfilePage.prototype.riskAddress = function () {
        var _this = this;
        ...
        returnResult.subscribe(function (val) {
            if (val) {
                ...
                _this.profile_form.patchValue(JSON);
            }
        });
    };
    ...
    MyProfilePage.prototype.get_user_Details = function () {
        var _this = this;
        this._cS.Display_Loader(true);
        this._cS.get_API(this._cS.URL_User_Details_Get())
            ...
            if (data.status == 0) {
                ...
                _this.user_Details.next(data.data);
            }
            else {
                _this._cS.logout();
                _this.user_Details.next(null);
    ...
    //     });
    // };
    MyProfilePage.prototype.back = function () {
        this.navCtrl.pop();
    };

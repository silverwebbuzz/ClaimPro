...
/* harmony import */ var _property_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./property.page */ "./src/app/property/property.page.ts");
...
var routes = [
    {
        path: '',
        component: _property_page__WEBPACK_IMPORTED_MODULE_9__["PropertyPage"]
    }
];
var PropertyPageModule = /** @class */ (function () {
    function PropertyPageModule() {
    }
    PropertyPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_property_page__WEBPACK_IMPORTED_MODULE_9__["PropertyPage"]],
            providers: [
...
/***/ "./src/app/property/property.page.scss":
/*!*********************************************!*\
  !*** ./src/app/property/property.page.scss ***!
  \*********************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Byb3BlcnR5L3Byb3BlcnR5LnBhZ2Uuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/property/property.page.ts":
/*!*******************************************!*\
  !*** ./src/app/property/property.page.ts ***!
  \*******************************************/
...
var PropertyPage = /** @class */ (function () {
    function PropertyPage(navCtrl, router, _cS, formBuilder, statusBar, actionSheetCtrl) {
    ...
    PropertyPage.prototype.property_fb = function () {
        this.property_form = this.formBuilder.group({
            policy_holder: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
    ...
    PropertyPage.prototype.propertyNext = function () {
        var _this = this;
        for (var v in this.property_form.controls) {
            ...
            if (this.property_form.value.policy_holder == 'true') {
                this._cS.post_API(this._cS.URL_Property_Claim_FirstStep_Post(), step0)
                    ...
                    if (data.status == 0) {
                        ...
                        localStorage.setItem('PropertyClaimNumber', _this.Claim_number);
                        _this.router.navigate(['/property-step1']);
                    }
                    else {
                    }
                }, function (err) {
    ...
    PropertyPage.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.property_form.setValue({
                        policy_holder: _this.editClaimData.policy_holder,
    ...
    PropertyPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    PropertyPage.prototype.detail = function () {
    ...
    PropertyPage.ctorParameters = function () { return [
    ...
    PropertyPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-property',
            template: __webpack_require__(/*! raw-loader!./property.page.html */ "./node_modules/raw-loader/index.js!./src/app/property/property.page.html"),
            styles: [__webpack_require__(/*! ./property.page.scss */ "./src/app/property/property.page.scss")]
        }),
...
//# sourceMappingURL=property-property-module-es5.js.map
...
var GeneralStep1PageModule = /** @class */ (function () {
    function GeneralStep1PageModule() {
    }
...
var GeneralStep1Page = /** @class */ (function () {
    function GeneralStep1Page(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    GeneralStep1Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    GeneralStep1Page.prototype.general_step1_fb = function () {
    ...
    GeneralStep1Page.prototype.formControlValueChanged = function () {
        var _this = this;
        this.general_form_step1.get('type_entitiy')
            .valueChanges.subscribe(function (val) {
            var client_company = _this.general_form_step1.get('client_company');
            if (val == "1001") {
        ...
        this.general_form_step1.get('employee_basis')
            .valueChanges.subscribe(function (val) {
            var employee_basis_other = _this.general_form_step1.get('employee_basis_other');
            if (val == "Other") {
        ...
        this.general_form_step1.get('association_name_picklist')
            .valueChanges.subscribe(function (val) {
            var association_name_picklist_other = _this.general_form_step1.get('association_name_picklist_other');
            if (val == "Other") {
        ...
        this.general_form_step1.get('description_business')
            .valueChanges.subscribe(function (val) {
            var description_business_other = _this.general_form_step1.get('description_business_other');
            if (val == "Other") {
    ...
    GeneralStep1Page.prototype.GeneralStep1Next = function () {
        var _this = this;
        for (var v in this.general_form_step1.controls) {
        ...
        if (this.general_form_step1.valid) {
            ...
            this._cS.put_API(this._cS.URL_General_Claim_Post(), step1)
                ...
                if (data.status == 0) {
                    _this.setClaimData();
                    _this.router.navigate(['/general-step2']);
                }
                else {
                }
            }, function (err) {
    ...
    GeneralStep1Page.prototype.ngOnInit = function () {
        var _this = this;
    ...
    GeneralStep1Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    GeneralStep1Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.general_form_step1.setValue({
                        ...
                        business_name: _this.editClaimData.business_name,
                        abn_client: _this.editClaimData.abn_client,
                        trading_name: _this.editClaimData.trading_name,
    ...
    GeneralStep1Page.ctorParameters = function () { return [
...
//# sourceMappingURL=general-liability-general-step1-general-step1-module-es5.js.map
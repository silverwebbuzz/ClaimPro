...
var VehicleStep2PageModule = /** @class */ (function () {
    function VehicleStep2PageModule() {
    }
...
var VehicleStep2Page = /** @class */ (function () {
    function VehicleStep2Page(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    VehicleStep2Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    VehicleStep2Page.prototype.vehicle_step2_fb = function () {
    ...
    VehicleStep2Page.prototype.vehicleStep2Next = function () {
        var _this = this;
        for (var v in this.vehicle_form_step2.controls) {
        ...
        if (this.vehicle_form_step2.valid) {
            ...
            this._cS.put_API(this._cS.URL_Vehicle_Claim_Post(), step2)
                ...
                if (data.status == 0) {
                    _this.setClaimData();
                    _this.router.navigate(['/vehicle-step3']);
                }
                else {
                }
            }, function (err) {
    ...
    VehicleStep2Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.vehicle_form_step2.setValue({
                        make: _this.editClaimData.make_of_vehicle,
                        year: _this.editClaimData.vehicle_year,
                        model: _this.editClaimData.body_model,
                        type_of_body: _this.editClaimData.type_of_body,
                        reg_number: _this.editClaimData.reg_number,
                    });
                }
            });
        }
    };
    VehicleStep2Page.prototype.ngOnInit = function () {
    };
    VehicleStep2Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    VehicleStep2Page.ctorParameters = function () { return [
...
//# sourceMappingURL=vehicle-vehicle-step2-vehicle-step2-module-es5.js.map
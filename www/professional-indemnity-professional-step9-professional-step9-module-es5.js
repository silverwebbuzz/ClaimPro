...
var ProfessionalStep9PageModule = /** @class */ (function () {
    function ProfessionalStep9PageModule() {
    }
    ...
    return ProfessionalStep9PageModule;
}());
...
var ProfessionalStep9Page = /** @class */ (function () {
    function ProfessionalStep9Page(_cS, route, router) {
        var _this = this;
        this._cS = _cS;
        this.route = route;
        this.router = router;
    ...
    ProfessionalStep9Page.prototype.submitFeedBack = function (claim_id, Feedback) {
        var _this = this;
        var body = {
            claimid: +claim_id,
    ...
    ;
    ProfessionalStep9Page.prototype.ngOnInit = function () {
    };
    ProfessionalStep9Page.ctorParameters = function () { return [
...
//# sourceMappingURL=professional-indemnity-professional-step9-professional-step9-module-es5.js.map
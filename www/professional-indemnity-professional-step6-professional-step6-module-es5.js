...
var ProfessionalStep6PageModule = /** @class */ (function () {
    function ProfessionalStep6PageModule() {
    }
    ...
    return ProfessionalStep6PageModule;
}());
...
var ProfessionalStep6Page = /** @class */ (function () {
    function ProfessionalStep6Page(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    ProfessionalStep6Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    ProfessionalStep6Page.prototype.formControlValueChanged = function () {
        var _this = this;
        this.professional_form_step6.get('previous_claims')
            .valueChanges.subscribe(function (val) {
            var previous_claim_date = _this.professional_form_step6.get('previous_claim_date');
            var previous_type_claim = _this.professional_form_step6.get('previous_type_claim');
            var previous_insurer = _this.professional_form_step6.get('previous_insurer');
        ...
        this.professional_form_step6.get('previous_type_claim')
            .valueChanges.subscribe(function (val) {
            var previous_type_claim_other = _this.professional_form_step6.get('previous_type_claim_other');
            if (val == "Other") {
    ...
    ProfessionalStep6Page.prototype.professional_step6_fb = function () {
    ...
    ProfessionalStep6Page.prototype.professionalStep6Next = function () {
        var _this = this;
        for (var v in this.professional_form_step6.controls) {
        ...
        if (this.professional_form_step6.valid) {
            ...
            this._cS.put_API(this._cS.URL_Professional_Claim_Post(), step6)
                ...
                if (data.status == 0) {
                    _this.setClaimData();
                    _this.router.navigate(['/professional-step7']);
                }
                else {
                }
            }, function (err) {
    ...
    ProfessionalStep6Page.prototype.ngOnInit = function () {
    };
    ProfessionalStep6Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    ProfessionalStep6Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.professional_form_step6.setValue({
    ...
    ProfessionalStep6Page.ctorParameters = function () { return [
...
//# sourceMappingURL=professional-indemnity-professional-step6-professional-step6-module-es5.js.map
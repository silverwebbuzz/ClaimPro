...
var GeneralStep6PageModule = /** @class */ (function () {
    function GeneralStep6PageModule() {
    }
...
var GeneralStep6Page = /** @class */ (function () {
    function GeneralStep6Page(modalCtrl, _cS, router, statusBar, navCtrl) {
    ...
    GeneralStep6Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    GeneralStep6Page.prototype.ngOnInit = function () {
    };
    GeneralStep6Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    GeneralStep6Page.prototype.submitClaim = function () {
        var _this = this;
        var body = {
            step: 'step6',
        ...
        this._cS.put_API(this._cS.URL_General_Claim_Post(), body)
            ...
            if (data.status == 0) {
                _this.Claim_number = localStorage.getItem('GeneralClaimNumber'),
                    localStorage.removeItem('GeneralClaimNumber');
                _this.router.navigate(['/general-step7'], { queryParams: { step: _this.Claim_number } });
            }
            else {
            }
        }, function (err) {
    ...
    ;
    GeneralStep6Page.prototype.reviewClaim = function () {
    ...
    GeneralStep6Page.ctorParameters = function () { return [
...
//# sourceMappingURL=general-liability-general-step6-general-step6-module-es5.js.map
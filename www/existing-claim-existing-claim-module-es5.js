...
var ExistingClaimPageModule = /** @class */ (function () {
    function ExistingClaimPageModule() {
    }
    ...
    return ExistingClaimPageModule;
}());
...
var ExistingClaimPage = /** @class */ (function () {
    function ExistingClaimPage(navCtrl, _cS, router, statusBar) {
    ...
    ExistingClaimPage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    ExistingClaimPage.prototype.ngOnInit = function () {
        var _this = this;
        this._cS.get_API_withToken(this._cS.URL_existing_claim_get())
            .subscribe(function (data) {
            // this.spinner.hide();
            if (data.status == 0) {
                _this.allexistingClaim = data.data;
            }
            // this.spinner.hide();
        }, function (err) {
            // this.spinner.hide();
    ...
    ExistingClaimPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    ExistingClaimPage.prototype.gotoExistingClaim = function (claimId, policy_type, step_status) {
    ...
    ExistingClaimPage.ctorParameters = function () { return [
...
//# sourceMappingURL=existing-claim-existing-claim-module-es5.js.map
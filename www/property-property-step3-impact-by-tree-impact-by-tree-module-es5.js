...
var ImpactByTreePageModule = /** @class */ (function () {
    function ImpactByTreePageModule() {
    }
...
var ImpactByTreePage = /** @class */ (function () {
    function ImpactByTreePage(navCtrl, router, formBuilder, statusBar) {
    ...
    ImpactByTreePage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    ImpactByTreePage.prototype.impact_by_tree_fb = function () {
    ...
    ImpactByTreePage.prototype.ImpactByTreeNext = function () {
        for (var v in this.impact_by_tree_form.controls) {
    ...
    ImpactByTreePage.prototype.ngOnInit = function () {
    };
    ImpactByTreePage.prototype.back = function () {
        this.navCtrl.pop();
    };
    ImpactByTreePage.ctorParameters = function () { return [
...
//# sourceMappingURL=property-property-step3-impact-by-tree-impact-by-tree-module-es5.js.map
...
var WhetherPageModule = /** @class */ (function () {
    function WhetherPageModule() {
    }
...
var WhetherPage = /** @class */ (function () {
    function WhetherPage(navCtrl, router, _cS, route, formBuilder, statusBar) {
    ...
    WhetherPage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    WhetherPage.prototype.weather_fb = function () {
    ...
    WhetherPage.prototype.weatherNext = function () {
        for (var v in this.weather_form.controls) {
    ...
    WhetherPage.prototype.ngOnInit = function () {
    };
    WhetherPage.prototype.next = function () {
        this.router.navigate(['/vehicle-step5']);
    };
    WhetherPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    WhetherPage.ctorParameters = function () { return [
...
//# sourceMappingURL=vehicle-vehicle-step3-whether-whether-module-es5.js.map
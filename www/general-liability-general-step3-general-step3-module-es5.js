...
var GeneralStep3PageModule = /** @class */ (function () {
    function GeneralStep3PageModule() {
    }
...
var GeneralStep3Page = /** @class */ (function () {
    function GeneralStep3Page(navCtrl, _cS, router, formBuilder, statusBar) {
    ...
    GeneralStep3Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    GeneralStep3Page.prototype.general_step3_fb = function () {
    ...
    GeneralStep3Page.prototype.formControlValueChanged = function () {
        var _this = this;
        /* Step 3 Start */
        this.general_form_step3.get('tp_legal_represented')
            .valueChanges.subscribe(function (val) {
            var tp_name_firm = _this.general_form_step3.get('tp_name_firm');
        ...
        this.general_form_step3.get('related_injury')
            .valueChanges.subscribe(function (val) {
            var nature_injury = _this.general_form_step3.get('nature_injury');
            var personal_injury = _this.general_form_step3.get('personal_injury');
        ...
        this.general_form_step3.get('type_damage')
            .valueChanges.subscribe(function (val) {
            var type_damage_other = _this.general_form_step3.get('type_damage_other');
            if (val == "Other") {
        ...
        this.general_form_step3.get('reported_loss')
            .valueChanges.subscribe(function (val) {
            var reported_loss_other = _this.general_form_step3.get('reported_loss_other');
            if (val == "Other") {
    ...
    GeneralStep3Page.prototype.GeneralStep3Next = function () {
        var _this = this;
        for (var v in this.general_form_step3.controls) {
        ...
        if (this.general_form_step3.valid) {
            ...
            this._cS.put_API(this._cS.URL_General_Claim_Post(), step3)
                ...
                if (data.status == 0) {
                    _this.setClaimData();
                    _this.router.navigate(['/general-step4']);
                }
                else {
    ...
    GeneralStep3Page.prototype.ngOnInit = function () {
        var script = document.createElement("script");
        script.src = "https://api.addressfinder.io/assets/v3/widget.js";
        script.async = true;
        document.body.appendChild(script);
    };
    GeneralStep3Page.prototype.tp_postalAddress = function () {
        var _this = this;
        ...
        returnResult.subscribe(function (val) {
            if (val) {
                ...
                _this.general_form_step3.patchValue(JSON);
            }
        });
    };
    GeneralStep3Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    GeneralStep3Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.general_form_step3.setValue({
                        ...
                        tp_legal_represented: _this.editClaimData.tp_legal_represented,
                        tp_name_firm: _this.editClaimData.tp_name_firm,
                        related_injury: _this.editClaimData.related_injury,
    ...
    GeneralStep3Page.ctorParameters = function () { return [
...
//# sourceMappingURL=general-liability-general-step3-general-step3-module-es5.js.map
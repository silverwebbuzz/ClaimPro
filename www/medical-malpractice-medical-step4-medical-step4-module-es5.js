...
var MedicalStep4PageModule = /** @class */ (function () {
    function MedicalStep4PageModule() {
    }
...
var MedicalStep4Page = /** @class */ (function () {
    function MedicalStep4Page(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    MedicalStep4Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    MedicalStep4Page.prototype.medical_step4_fb = function () {
    ...
    MedicalStep4Page.prototype.formControlValueChanged = function () {
        var _this = this;
        this.medical_form_step4.get('patient_complaint')
            .valueChanges.subscribe(function (val) {
            var age_patient = _this.medical_form_step4.get('age_patient');
            var where_incident = _this.medical_form_step4.get('where_incident');
            var treatment_period = _this.medical_form_step4.get('treatment_period');
            var patient_condition = _this.medical_form_step4.get('patient_condition');
            var what_treatment = _this.medical_form_step4.get('what_treatment');
            var type_patient = _this.medical_form_step4.get('type_patient');
            var sex_patient = _this.medical_form_step4.get('sex_patient');
        ...
        this.medical_form_step4.get('where_incident')
            .valueChanges.subscribe(function (val) {
            var where_incident_other = _this.medical_form_step4.get('where_incident_other');
            if (val == "1900") {
        ...
        this.medical_form_step4.get('type_patient')
            .valueChanges.subscribe(function (val) {
            var type_patient_other = _this.medical_form_step4.get('type_patient_other');
            if (val == "1935") {
        ...
        this.medical_form_step4.get('sex_patient')
            .valueChanges.subscribe(function (val) {
            var sex_patient_other = _this.medical_form_step4.get('sex_patient_other');
            if (val == 'Other') {
        ...
        this.medical_form_step4.get('medical_malpractice')
            .valueChanges.subscribe(function (val) {
            var medical_malpractice_other = _this.medical_form_step4.get('medical_malpractice_other');
            if (val == "1636") {
    ...
    MedicalStep4Page.prototype.medicalStep4Next = function () {
        var _this = this;
        for (var v in this.medical_form_step4.controls) {
            this.medical_form_step4.controls[v].markAsTouched();
        }
        if (this.medical_form_step4.valid) {
            /* Patient Addres Start */
            var patientStreetValue = null;
            var patientSuburbValue = null;
            var patientPostCodeValue = null;
            var patientStateValue = null;
            var patientcountryValue = null;
            ...
            this._cS.put_API(this._cS.URL_Medical_Claim_Post(), step4)
                ...
                if (data.status == 0) {
                    ...
                    _this.setClaimData();
                    _this.router.navigate(['/medical-step5']);
                }
                else {
                }
            }, function (err) {
    ...
    MedicalStep4Page.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this._cS.getoptionvalue_API(117)
            .subscribe(function (data) {
            if (data.status == 0) {
                _this.where_incident = data.data;
            }
        });
        /* Type of patient */
        ...
        this._cS.getoptionvalue_API(140)
            .subscribe(function (data) {
            if (data.status == 0) {
                _this.medical_malpractice = data.data;
            }
        });
    };
    MedicalStep4Page.prototype.patientAddress = function () {
        var _this = this;
        var widget = new AddressFinder.Widget(document.getElementById("patient_street"), "PVW639JF4ET8ALGDHNKB", "AU", {});
        ...
        returnResult.subscribe(function (val) {
            if (val) {
                ...
                _this.medical_form_step4.patchValue(JSON);
            }
        });
    };
    MedicalStep4Page.prototype.dynamicImages = function (array, path) {
        var _this = this;
    ...
    MedicalStep4Page.prototype.delete_complaint_documents = function (img, position) {
        var _this = this;
    ...
    MedicalStep4Page.prototype.complaint_documents = function (event) {
        var _this = this;
    ...
    MedicalStep4Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    if (_this.editClaimData.medical_malpractice) {
                        var medical_malpractice = JSON.parse(_this.editClaimData.medical_malpractice);
                    ...
                    if (_this.editClaimData.type_patient) {
                        var type_patient = JSON.parse(_this.editClaimData.type_patient);
                    ...
                    if (_this.editClaimData.where_incident) {
                        var where_incident = JSON.parse(_this.editClaimData.where_incident);
                    ...
                    _this.medical_form_step4.setValue({
                        patient_complaint: _this.editClaimData.patient_complaint,
                        loss_date_discovery: _this.editClaimData.loss_date_discovery,
                        complaint_writing: _this.editClaimData.complaint_writing,
                        tp_christian_patient: _this.editClaimData.tp_christian_patient,
                        tp_name_patient: _this.editClaimData.tp_name_patient,
                        patient_street: _this.editClaimData.tp_postal_street,
                        patient_suburb_town: _this.editClaimData.tp_postal_suburb,
                        patient_post_code: _this.editClaimData.tp_postal_postcode,
                        patient_state: _this.editClaimData.tp_postal_state,
                        patient_email: _this.editClaimData.tp_postal_email,
                        patient_telephone: _this.editClaimData.tp_tele_main,
                        age_patient: _this.editClaimData.age_patient,
                        where_incident: where_incident_set,
                        where_incident_other: _this.editClaimData.where_incident_other,
                        treatment_period: _this.editClaimData.treatment_period,
                        patient_condition: _this.editClaimData.patient_condition,
                        what_treatment: _this.editClaimData.what_treatment,
                        type_patient: type_patient_set,
                        type_patient_other: _this.editClaimData.type_patient_other,
                        sex_patient: _this.editClaimData.sex_patient,
                        sex_patient_other: _this.editClaimData.sex_patient_other,
                        medical_malpractice: medical_malpractice_set,
                        medical_malpractice_other: _this.editClaimData.medical_malpractice_other,
    ...
    MedicalStep4Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    MedicalStep4Page.ctorParameters = function () { return [
...
//# sourceMappingURL=medical-malpractice-medical-step4-medical-step4-module-es5.js.map
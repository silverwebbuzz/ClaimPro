...
var ChangepassPage = /** @class */ (function () {
    function ChangepassPage(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    ChangepassPage.prototype.change_pass_fb = function () {
    ...
    ChangepassPage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
    ...
    ChangepassPage.prototype.submit = function () {
        var _this = this;
        for (var v in this.change_pass_form.controls) {
    ...
    ChangepassPage.prototype.back = function () {
        this.navCtrl.pop();
    };

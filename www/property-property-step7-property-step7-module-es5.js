...
var PropertyStep7PageModule = /** @class */ (function () {
    function PropertyStep7PageModule() {
    }
    ...
    return PropertyStep7PageModule;
}());
...
var PropertyStep7Page = /** @class */ (function () {
    function PropertyStep7Page(navCtrl, router, _cS, formBuilder, statusBar) {
    ...
    PropertyStep7Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    PropertyStep7Page.prototype.property_step7_fb = function () {
    ...
    PropertyStep7Page.prototype.propertyStep7Next = function () {
        var _this = this;
        for (var v in this.property_form_step7.controls) {
        ...
        if (this.property_form_step7.valid) {
            ...
            this._cS.put_API(this._cS.URL_Property_Claim_Post(), step7)
                ...
                if (data.status == 0) {
                    _this.setClaimData();
                    _this.router.navigate(['/property-step8']);
                }
                else {
                }
            }, function (err) {
    ...
    PropertyStep7Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.property_form_step7.setValue({
    ...
    PropertyStep7Page.prototype.ngOnInit = function () {
    };
    PropertyStep7Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    PropertyStep7Page.ctorParameters = function () { return [
...
//# sourceMappingURL=property-property-step7-property-step7-module-es5.js.map
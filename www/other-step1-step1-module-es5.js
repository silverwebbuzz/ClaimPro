...
var Step1Page = /** @class */ (function () {
    ...
    function Step1Page(navCtrl, router, _cS, formBuilder, actionSheetCtrl, statusBar) {
    ...
    Step1Page.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    Step1Page.prototype.other_step1_fb = function () {
    ...
    Step1Page.prototype.formControlValueChanged = function () {
        var _this = this;
        this.other_form_step1.get('type_entitiy')
            .valueChanges.subscribe(function (val) {
            var client_company = _this.other_form_step1.get('client_company');
            if (val == "1001") {
    ...
    Step1Page.prototype.otherStep1Next = function () {
        var _this = this;
        for (var v in this.other_form_step1.controls) {
    ...
    Step1Page.prototype.back = function () {
        this.navCtrl.pop();
    };
    Step1Page.prototype.setClaimData = function () {
        var _this = this;
        ...
        if (claimNumber) {
            this._cS.get_API_Data(this._cS.URL_Ref_Claim_data(), claimNumber)
                ...
                if (data.status == 0) {
                    ...
                    _this.other_form_step1.setValue({
    ...
    Step1Page.prototype.detail = function () {
    ...
    Step1Page.ctorParameters = function () { return [
...
//# sourceMappingURL=other-step1-step1-module-es5.js.map
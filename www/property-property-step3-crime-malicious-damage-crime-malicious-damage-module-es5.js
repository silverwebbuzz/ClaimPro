...
var CrimeMaliciousDamagePageModule = /** @class */ (function () {
    function CrimeMaliciousDamagePageModule() {
    }
    ...
    return CrimeMaliciousDamagePageModule;
}());
...
var CrimeMaliciousDamagePage = /** @class */ (function () {
    function CrimeMaliciousDamagePage(navCtrl, router, formBuilder, statusBar) {
    ...
    CrimeMaliciousDamagePage.prototype.ionViewWillEnter = function () {
        this.statusBar.show();
        this.statusBar.styleDefault();
        this.statusBar.backgroundColorByHexString('#ffffff');
    };
    CrimeMaliciousDamagePage.prototype.crime_malicious_fb = function () {
    ...
    CrimeMaliciousDamagePage.prototype.crimeMaliciousNext = function () {
        for (var v in this.crime_malicious_form.controls) {
    ...
    CrimeMaliciousDamagePage.prototype.ngOnInit = function () {
    };
    CrimeMaliciousDamagePage.prototype.back = function () {
        this.navCtrl.pop();
    };
    CrimeMaliciousDamagePage.ctorParameters = function () { return [
    ...
    return CrimeMaliciousDamagePage;
}());
...
//# sourceMappingURL=property-property-step3-crime-malicious-damage-crime-malicious-damage-module-es5.js.map